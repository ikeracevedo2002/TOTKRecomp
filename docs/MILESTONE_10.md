...
The current module result counts unresolved imports as runtime/import
boundaries. Horizon and other runtime behavior are reported as boundaries by
the existing unsupported/error taxonomy and remain future work.
...
- calls and boundaries: direct calls, indirect calls, resolved/unresolved
  indirect flow, imports, and runtime boundaries.
...
| Unresolved import | Prevent strict success | Keep reportable boundary |
...
- No real TOTK main has been analyzed in this change.
